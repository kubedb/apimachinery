...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DruidClusterSummary) DeepCopyInto(out *DruidClusterSummary) {
	*out = *in
	...
	if in.TotalSegments != nil {
		in, out := &in.TotalSegments, &out.TotalSegments
		*out = new(int64)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DruidClusterSummary.
func (in *DruidClusterSummary) DeepCopy() *DruidClusterSummary {
	if in == nil {
		return nil
	}
	out := new(DruidClusterSummary)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DruidServiceStatus) DeepCopyInto(out *DruidServiceStatus) {
	*out = *in
	...
	if in.TotalMemoryBytes != nil {
		in, out := &in.TotalMemoryBytes, &out.TotalMemoryBytes
		*out = new(int64)
		**out = **in
	}
	if in.CurrentSizeBytes != nil {
		in, out := &in.CurrentSizeBytes, &out.CurrentSizeBytes
		*out = new(int64)
		**out = **in
	}
