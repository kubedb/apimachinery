...
type MySQLQuerySpec struct {
	...
	RowsSent                int64        `json:"rowsSent,omitempty" protobuf:"varint,5,opt,name=rowsSent"`
	RowsExamined            int64        `json:"rowsExamined,omitempty" protobuf:"varint,6,opt,name=rowsExamined"`
