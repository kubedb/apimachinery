...
func schema_apimachinery_apis_archiver_v1alpha1_ArchiverDatabaseRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_archiver_v1alpha1_BackupStorage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"name", "envToSecretKey"},
			},
		},
	}
}
...
func schema_apimachinery_apis_archiver_v1alpha1_MongoDBArchiver(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubedb.dev/apimachinery/apis/archiver/v1alpha1.MongoDBArchiverSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubedb.dev/apimachinery/apis/archiver/v1alpha1.MongoDBArchiverStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubedb.dev/apimachinery/apis/archiver/v1alpha1.MongoDBArchiverSpec", "kubedb.dev/apimachinery/apis/archiver/v1alpha1.MongoDBArchiverStatus"},
	}
}

func schema_apimachinery_apis_archiver_v1alpha1_MongoDBArchiverList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubedb.dev/apimachinery/apis/archiver/v1alpha1.MongoDBArchiver"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubedb.dev/apimachinery/apis/archiver/v1alpha1.MongoDBArchiver"},
	}
}

func schema_apimachinery_apis_archiver_v1alpha1_MongoDBArchiverSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MongoDBArchiverSpec defines the desired state of MongoDBArchiver",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"databases": {
						SchemaProps: spec.SchemaProps{
...
func schema_apimachinery_apis_archiver_v1alpha1_MongoDBArchiverStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_apimachinery_apis_archiver_v1alpha1_SchedulerOptions(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
