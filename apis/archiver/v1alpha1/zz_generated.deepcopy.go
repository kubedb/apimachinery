...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CSISnapshotterOptions) DeepCopyInto(out *CSISnapshotterOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CSISnapshotterOptions.
func (in *CSISnapshotterOptions) DeepCopy() *CSISnapshotterOptions {
	if in == nil {
		return nil
	}
	out := new(CSISnapshotterOptions)
	in.DeepCopyInto(out)
	return out
}
