...
//+kubebuilder:webhook:path=/validate-connectcluster-kafka-kubedb-com-v1alpha1-connectcluster,mutating=false,failurePolicy=fail,sideEffects=None,groups=kafka.kubedb.com,resources=connectclusters,verbs=create;update,versions=v1alpha1,name=vconnectclusters.kb.io,admissionReviewVersions={v1,v1beta1}
...
func (k *ConnectCluster) ValidateCreate() (admission.Warnings, error) {
	...
	return nil, apierrors.NewInvalid(schema.GroupKind{Group: "kafka.kubedb.com", Kind: "Kafka"}, k.Name, k.ValidateCreateOrUpdate())
}
