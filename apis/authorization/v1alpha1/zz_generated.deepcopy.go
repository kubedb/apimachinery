...
func (in *AuthManager) DeepCopyInto(out *AuthManager) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthManager.
func (in *AuthManager) DeepCopy() *AuthManager {
	if in == nil {
		return nil
	}
	out := new(AuthManager)
...
func (in *MongoDBRoleSpec) DeepCopyInto(out *MongoDBRoleSpec) {
	*out = *in
	in.AuthManager.DeepCopyInto(&out.AuthManager)
...
func (in *PostgresRoleSpec) DeepCopyInto(out *PostgresRoleSpec) {
	*out = *in
	if in.AuthManager != nil {
		in, out := &in.AuthManager, &out.AuthManager
		if *in == nil {
			*out = nil
		} else {
			*out = new(AuthManager)
