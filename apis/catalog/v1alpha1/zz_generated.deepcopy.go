...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackintAgent) DeepCopyInto(out *BackintAgent) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackintAgent.
func (in *BackintAgent) DeepCopy() *BackintAgent {
	if in == nil {
		return nil
	}
	out := new(BackintAgent)
	in.DeepCopyInto(out)
	return out
}
