...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PostgresFeatures) DeepCopyInto(out *PostgresFeatures) {
	*out = *in
	if in.RunAsUser != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostgresFeatures.
func (in *PostgresFeatures) DeepCopy() *PostgresFeatures {
	if in == nil {
		return nil
	}
	out := new(PostgresFeatures)
	in.DeepCopyInto(out)
	return out
}
