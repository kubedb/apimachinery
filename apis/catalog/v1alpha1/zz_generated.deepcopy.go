...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MySQLModificationRequestUpgradeConstraints) DeepCopyInto(out *MySQLModificationRequestUpgradeConstraints) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MySQLModificationRequestUpgradeConstraints.
func (in *MySQLModificationRequestUpgradeConstraints) DeepCopy() *MySQLModificationRequestUpgradeConstraints {
	if in == nil {
		return nil
	}
	out := new(MySQLModificationRequestUpgradeConstraints)
	in.DeepCopyInto(out)
	return out
}
