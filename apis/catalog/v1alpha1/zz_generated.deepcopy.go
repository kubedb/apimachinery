...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DB2SecurityContext) DeepCopyInto(out *DB2SecurityContext) {
	*out = *in
	if in.RunAsUser != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DB2SecurityContext.
func (in *DB2SecurityContext) DeepCopy() *DB2SecurityContext {
	if in == nil {
		return nil
	}
	out := new(DB2SecurityContext)
	in.DeepCopyInto(out)
	return out
}
