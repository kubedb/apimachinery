...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FerretDBSecurityContext) DeepCopyInto(out *FerretDBSecurityContext) {
	*out = *in
	if in.RunAsUser != nil {
		in, out := &in.RunAsUser, &out.RunAsUser
		*out = new(int64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FerretDBSecurityContext.
func (in *FerretDBSecurityContext) DeepCopy() *FerretDBSecurityContext {
	if in == nil {
		return nil
	}
	out := new(FerretDBSecurityContext)
	in.DeepCopyInto(out)
	return out
}
