...
const (
	ResourceCodeProxySQLVersion     = "psqlversion"
...
// +kubebuilder:resource:path=proxysqlversions,singular=proxysqlversion,scope=Cluster,shortName=psqlversion,categories={datastore,kubedb,appscode}
