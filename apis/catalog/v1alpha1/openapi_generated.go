...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubedb.dev/apimachinery/apis/catalog/v1alpha1.MySQLVersionLabeler":                   schema_apimachinery_apis_catalog_v1alpha1_MySQLVersionLabeler(ref),
...
func schema_apimachinery_apis_catalog_v1alpha1_MySQLVersionLabeler(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MySQLVersionLabeler is the image for the MySQL labeler",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"image": {
						SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"labeler": {
						SchemaProps: spec.SchemaProps{
							Description: "Labeler Image",
							Ref:         ref("kubedb.dev/apimachinery/apis/catalog/v1alpha1.MySQLVersionLabeler"),
						},
					},
					"deprecated": {
						SchemaProps: spec.SchemaProps{
