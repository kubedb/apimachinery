...
func (in *ElasticsearchStatus) DeepCopyInto(out *ElasticsearchStatus) {
	*out = *in
	...
	if in.DisasterRecovery != nil {
		...
		*out = new(ElasticsearchDisasterRecoveryStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticsearchDisasterRecoveryStatus) DeepCopyInto(out *ElasticsearchDisasterRecoveryStatus) {
	*out = *in
	if in.DataCenters != nil {
		in, out := &in.DataCenters, &out.DataCenters
		*out = make([]ElasticsearchDCStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticsearchDisasterRecoveryStatus.
func (in *ElasticsearchDisasterRecoveryStatus) DeepCopy() *ElasticsearchDisasterRecoveryStatus {
	if in == nil {
		return nil
	}
	out := new(ElasticsearchDisasterRecoveryStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticsearchDCStatus) DeepCopyInto(out *ElasticsearchDCStatus) {
	*out = *in
	...
	if in.FollowLagOps != nil {
		in, out := &in.FollowLagOps, &out.FollowLagOps
		*out = new(int64)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticsearchDCStatus.
func (in *ElasticsearchDCStatus) DeepCopy() *ElasticsearchDCStatus {
	if in == nil {
		return nil
	}
	out := new(ElasticsearchDCStatus)
	in.DeepCopyInto(out)
	return out
}
