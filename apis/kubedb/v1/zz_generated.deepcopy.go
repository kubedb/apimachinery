...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaLicenseSpec) DeepCopyInto(out *KafkaLicenseSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaLicenseSpec.
func (in *KafkaLicenseSpec) DeepCopy() *KafkaLicenseSpec {
	if in == nil {
		return nil
	}
	out := new(KafkaLicenseSpec)
	in.DeepCopyInto(out)
	return out
}
