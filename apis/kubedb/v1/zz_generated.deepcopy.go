...
func (in *MongoDBStatus) DeepCopyInto(out *MongoDBStatus) {
	*out = *in
	...
	if in.DisasterRecovery != nil {
		...
		*out = new(MongoDBDisasterRecoveryStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MongoDBDisasterRecoveryStatus) DeepCopyInto(out *MongoDBDisasterRecoveryStatus) {
	*out = *in
	if in.DataCenters != nil {
		in, out := &in.DataCenters, &out.DataCenters
		*out = make([]MongoDBDCStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MongoDBDisasterRecoveryStatus.
func (in *MongoDBDisasterRecoveryStatus) DeepCopy() *MongoDBDisasterRecoveryStatus {
	if in == nil {
		return nil
	}
	out := new(MongoDBDisasterRecoveryStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MongoDBDCStatus) DeepCopyInto(out *MongoDBDCStatus) {
	*out = *in
	if in.OplogLagSeconds != nil {
		in, out := &in.OplogLagSeconds, &out.OplogLagSeconds
		*out = new(int64)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MongoDBDCStatus.
func (in *MongoDBDCStatus) DeepCopy() *MongoDBDCStatus {
	if in == nil {
		return nil
	}
	out := new(MongoDBDCStatus)
	in.DeepCopyInto(out)
	return out
}
