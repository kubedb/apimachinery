...
const (
	...
	ClickHouseClientCertVolumeName           = "cacerts"
	ClickHouseClientCertVolumeMountPath      = "/etc/clickhouse-server/certs"
	ClickHouseTempClientCertVolumeName       = "cacerts-temp"
	ClickHouseTempmClientCertVolumeMountPath = "/ch-certs"
