...
const (
	...
	IgniteServerKeystoreFile   = "/ignite/certs/server/keystore.p12"
	IgniteServerTruststoreFile = "/ignite/certs/server/truststore.p12"
	IgniteClientKeystoreFile   = "/ignite/certs/client/keystore.p12"
	IgniteClientTruststoreFile = "/ignite/certs/client/truststore.p12"
