...
// Convert_v1alpha2_Archiver_To_v1_Archiver is a manual conversion function. The Ref field is a
// value in v1alpha2 but an optional pointer in v1, so it cannot be converted via unsafe.Pointer.
...
// Convert_v1_Archiver_To_v1alpha2_Archiver is a manual conversion function. The Ref field is an
// optional pointer in v1 but a value in v1alpha2, so it cannot be converted via unsafe.Pointer.
func Convert_v1_Archiver_To_v1alpha2_Archiver(in *v1.Archiver, out *Archiver, s conversion.Scope) error {
	out.Pause = in.Pause
	if in.Ref != nil {
		out.Ref = *in.Ref
	} else {
		out.Ref = clientgoapiv1.ObjectReference{}
	}
	return nil
}
...
func Convert_v1alpha2_MariaDBSpec_To_v1_MariaDBSpec(in *MariaDBSpec, out *v1.MariaDBSpec, s conversion.Scope) error {
	...
	if in.Archiver != nil {
		out.Archiver = &v1.Archiver{}
		if err := Convert_v1alpha2_Archiver_To_v1_Archiver(in.Archiver, out.Archiver, s); err != nil {
			return err
		}
	} else {
		out.Archiver = nil
...
func Convert_v1_MariaDBSpec_To_v1alpha2_MariaDBSpec(in *v1.MariaDBSpec, out *MariaDBSpec, s conversion.Scope) error {
	...
	out.HealthChecker = in.HealthChecker
	if in.Archiver != nil {
		out.Archiver = &Archiver{}
		if err := Convert_v1_Archiver_To_v1alpha2_Archiver(in.Archiver, out.Archiver, s); err != nil {
			return err
		}
	} else {
		out.Archiver = nil
