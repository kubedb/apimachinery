...
func autoConvert_v1_CoordinatorSpec_To_v1alpha2_CoordinatorSpec(in []*corev1.Container, out *CoordinatorSpec, s conversion.Scope) error {
	...
	for _, cont := range in {
		if cont.Name == kubedb.PostgresCoordinatorContainerName {
			container = cont
		}
	}
	...
	out.SecurityContext = (*corev1.SecurityContext)(unsafe.Pointer(container.SecurityContext))
	return nil
}
	...
	for _, cont := range out {
		if cont.Name == kubedb.PostgresCoordinatorContainerName {
			if container.SecurityContext != nil {
				cont.SecurityContext = container.SecurityContext
			}
			if container.Resources.Limits != nil || container.Resources.Requests != nil {
				cont.Resources = *container.Resources.DeepCopy()
			}
			found = true
		}
	}
