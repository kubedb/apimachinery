...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QdrantInitSpec) DeepCopyInto(out *QdrantInitSpec) {
	*out = *in
	if in.Restore != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QdrantInitSpec.
func (in *QdrantInitSpec) DeepCopy() *QdrantInitSpec {
	if in == nil {
		return nil
	}
	out := new(QdrantInitSpec)
	in.DeepCopyInto(out)
	return out
}
