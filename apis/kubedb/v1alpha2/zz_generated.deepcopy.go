...
func (in *ClickHouseTLSConfig) DeepCopyInto(out *ClickHouseTLSConfig) {
	*out = *in
	...
	if in.ClientTLSCaCertRef != nil {
		in, out := &in.ClientTLSCaCertRef, &out.ClientTLSCaCertRef
		*out = new(ClientTLSCaCertRef)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientTLSCaCertRef) DeepCopyInto(out *ClientTLSCaCertRef) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientTLSCaCertRef.
func (in *ClientTLSCaCertRef) DeepCopy() *ClientTLSCaCertRef {
	if in == nil {
		return nil
	}
	out := new(ClientTLSCaCertRef)
