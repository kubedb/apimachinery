...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeepStorage) DeepCopyInto(out *DeepStorage) {
	*out = *in
	if in.Type != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeepStorage.
func (in *DeepStorage) DeepCopy() *DeepStorage {
	if in == nil {
		return nil
	}
	out := new(DeepStorage)
