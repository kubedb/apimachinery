...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BoltTLSConfig) DeepCopyInto(out *BoltTLSConfig) {
	*out = *in
	if in.Enabled != nil {
	...
	if in.MTLSEnabled != nil {
		in, out := &in.MTLSEnabled, &out.MTLSEnabled
		*out = new(bool)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BoltTLSConfig.
func (in *BoltTLSConfig) DeepCopy() *BoltTLSConfig {
	if in == nil {
		return nil
	}
	out := new(BoltTLSConfig)
	in.DeepCopyInto(out)
	return out
}
