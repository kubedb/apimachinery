	...
	*out = *in
	if in.SRIOV != nil {
		...
		*out = new(MilvusSRIOVSpec)
		// SRIOV now carries a pointer field (GDS), so a shallow "**out =
		// **in" would alias it between in and out instead of deep-copying
		// it -- must go through SRIOV's own DeepCopyInto.
		(*in).DeepCopyInto(*out)
	}
	return
}
