...
func (in *ArchiverRecovery) DeepCopyInto(out *ArchiverRecovery) {
	*out = *in
	...
	if in.ManifestRestore != nil {
		in, out := &in.ManifestRestore, &out.ManifestRestore
		*out = new(ManifestRestoreOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.FullDBRestore != nil {
		in, out := &in.FullDBRestore, &out.FullDBRestore
		*out = new(FullDBRestoreOptions)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullDBRestoreOptions) DeepCopyInto(out *FullDBRestoreOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullDBRestoreOptions.
func (in *FullDBRestoreOptions) DeepCopy() *FullDBRestoreOptions {
	if in == nil {
		return nil
	}
	out := new(FullDBRestoreOptions)
