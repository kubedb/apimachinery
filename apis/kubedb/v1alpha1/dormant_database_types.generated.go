...
const (
	// ----- content types ----
	codecSelferC_UTF82468 = 1
	codecSelferC_RAW2468  = 0
	// ----- value types used ----
	codecSelferValueTypeArray2468 = 10
	codecSelferValueTypeMap2468   = 9
	// ----- containerStateValues ----
	codecSelfer_containerMapKey2468    = 2
	codecSelfer_containerMapValue2468  = 3
	codecSelfer_containerMapEnd2468    = 4
	codecSelfer_containerArrayElem2468 = 6
	codecSelfer_containerArrayEnd2468  = 7
)

var (
	codecSelferBitsize2468                         = uint8(reflect.TypeOf(uint(0)).Bits())
	codecSelferOnlyMapOrArrayEncodeToStructErr2468 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer2468 struct{}
...
func (x *DormantDatabase) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem2468)
				if yyq2[0] {
					yym4 := z.EncBinary()
					_ = yym4
					if false {
					} else {
						r.EncodeString(codecSelferC_UTF82468, string(x.Kind))
					}
				} else {
					r.EncodeString(codecSelferC_UTF82468, "")
				}
			} else {
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("kind"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF82468, string(x.APIVersion))
					}
				} else {
					r.EncodeString(codecSelferC_UTF82468, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("apiVersion"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("metadata"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yy12 := &x.ObjectMeta
					yym13 := z.EncBinary()
					_ = yym13
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("spec"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yy17 := &x.Spec
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("status"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yy22 := &x.Status
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayEnd2468)
			} else {
				z.EncSendContainerState(codecSelfer_containerMapEnd2468)
			}
		}
	}
}
...
func (x *DormantDatabase) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap2468 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerMapEnd2468)
			} else {
				x.codecDecodeSelfFromMap(yyl2, d)
			}
		} else if yyct2 == codecSelferValueTypeArray2468 {
			yyl2 := r.ReadArrayStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerArrayEnd2468)
			} else {
				x.codecDecodeSelfFromArray(yyl2, d)
			}
		} else {
			panic(codecSelferOnlyMapOrArrayEncodeToStructErr2468)
		}
	}
}
...
func (x *DormantDatabase) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		z.DecSendContainerState(codecSelfer_containerMapKey2468)
		yys3Slc = r.DecodeBytes(yys3Slc, true, true)
		yys3 := string(yys3Slc)
		z.DecSendContainerState(codecSelfer_containerMapValue2468)
		switch yys3 {
		case "kind":
			if r.TryDecodeAsNil() {
				x.Kind = ""
...
func (x *DormantDatabase) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	z.DecSendContainerState(codecSelfer_containerArrayElem2468)
	if r.TryDecodeAsNil() {
		x.Kind = ""
	} else {
		yyv13 := &x.Kind
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("wipeOut"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("resume"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("origin"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yy12 := &x.Origin
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("elasticsearch"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					if x.Elasticsearch == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("postgres"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					if x.Postgres == nil {
						r.EncodeNil()
					} else {
...
func (x DormantDatabasePhase) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if false {
		...
		r.EncodeString(codecSelferC_UTF82468, string(x))
	}
}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("creationTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					if x.CreationTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("pausingTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					if x.PausingTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("wipeOutTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					if x.WipeOutTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("phase"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					x.Phase.CodecEncodeSelf(e)
				}
			}
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF82468, string(x.Reason))
					}
				} else {
					r.EncodeString(codecSelferC_UTF82468, "")
				}
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("reason"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					yym17 := z.EncBinary()
					_ = yym17
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey2468)
					r.EncodeString(codecSelferC_UTF82468, string("items"))
					z.EncSendContainerState(codecSelfer_containerMapValue2468)
					if x.Items == nil {
						r.EncodeNil()
					} else {
...
func (x codecSelfer2468) encSliceDormantDatabase(v []DormantDatabase, e *codec1978.Encoder) {
	var h codecSelfer2468
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer2468) decSliceDormantDatabase(v *[]DormantDatabase, d *codec1978.Decoder) {
	var h codecSelfer2468
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
