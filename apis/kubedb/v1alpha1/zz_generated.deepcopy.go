...
func (in *ElasticsearchSpec) DeepCopyInto(out *ElasticsearchSpec) {
	*out = *in
	...
	if in.RolesMapping != nil {
		...
		*out = make(map[string]RoleMapSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleMapSpec) DeepCopyInto(out *RoleMapSpec) {
	*out = *in
	if in.BackendRoles != nil {
		in, out := &in.BackendRoles, &out.BackendRoles
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleMapSpec.
func (in *RoleMapSpec) DeepCopy() *RoleMapSpec {
	if in == nil {
		return nil
	}
	out := new(RoleMapSpec)
