...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MongoDBCommonShardNode) DeepCopyInto(out *MongoDBCommonShardNode) {
	*out = *in
	in.MongoDBShardNode.DeepCopyInto(&out.MongoDBShardNode)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MongoDBCommonShardNode.
func (in *MongoDBCommonShardNode) DeepCopy() *MongoDBCommonShardNode {
	if in == nil {
		return nil
	}
	out := new(MongoDBCommonShardNode)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MongoDBShardingTopology) DeepCopyInto(out *MongoDBShardingTopology) {
	*out = *in
	...
	if in.CommonShards != nil {
		in, out := &in.CommonShards, &out.CommonShards
		*out = new(MongoDBCommonShardNode)
		(*in).DeepCopyInto(*out)
	}
	if in.Shards != nil {
		in, out := &in.Shards, &out.Shards
		*out = make([]MongoDBShardNode, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
