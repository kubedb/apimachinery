...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_PostgresArchive_To_kubedb_PostgresArchive,
		Convert_kubedb_PostgresArchive_To_v1alpha1_PostgresArchive,
		Convert_v1alpha1_PostgresConfiguration_To_kubedb_PostgresConfiguration,
		Convert_kubedb_PostgresConfiguration_To_v1alpha1_PostgresConfiguration,
...
func autoConvert_v1alpha1_PostgresArchive_To_kubedb_PostgresArchive(in *PostgresArchive, out *kubedb.PostgresArchive, s conversion.Scope) error {
	out.Type = in.Type
	out.Secret = (*core_v1.SecretVolumeSource)(unsafe.Pointer(in.Secret))
	return nil
}

// Convert_v1alpha1_PostgresArchive_To_kubedb_PostgresArchive is an autogenerated conversion function.
func Convert_v1alpha1_PostgresArchive_To_kubedb_PostgresArchive(in *PostgresArchive, out *kubedb.PostgresArchive, s conversion.Scope) error {
	return autoConvert_v1alpha1_PostgresArchive_To_kubedb_PostgresArchive(in, out, s)
}

func autoConvert_kubedb_PostgresArchive_To_v1alpha1_PostgresArchive(in *kubedb.PostgresArchive, out *PostgresArchive, s conversion.Scope) error {
	out.Type = in.Type
	out.Secret = (*core_v1.SecretVolumeSource)(unsafe.Pointer(in.Secret))
	return nil
}

// Convert_kubedb_PostgresArchive_To_v1alpha1_PostgresArchive is an autogenerated conversion function.
func Convert_kubedb_PostgresArchive_To_v1alpha1_PostgresArchive(in *kubedb.PostgresArchive, out *PostgresArchive, s conversion.Scope) error {
	return autoConvert_kubedb_PostgresArchive_To_v1alpha1_PostgresArchive(in, out, s)
}
...
// Convert_v1alpha1_PostgresConfiguration_To_kubedb_PostgresConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_PostgresConfiguration_To_kubedb_PostgresConfiguration(in *PostgresConfiguration, out *kubedb.PostgresConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_PostgresConfiguration_To_kubedb_PostgresConfiguration(in, out, s)
}
...
// Convert_kubedb_PostgresConfiguration_To_v1alpha1_PostgresConfiguration is an autogenerated conversion function.
func Convert_kubedb_PostgresConfiguration_To_v1alpha1_PostgresConfiguration(in *kubedb.PostgresConfiguration, out *PostgresConfiguration, s conversion.Scope) error {
	return autoConvert_kubedb_PostgresConfiguration_To_v1alpha1_PostgresConfiguration(in, out, s)
}
...
func autoConvert_v1alpha1_PostgresSpec_To_kubedb_PostgresSpec(in *PostgresSpec, out *kubedb.PostgresSpec, s conversion.Scope) error {
	...
	out.Archive = (*kubedb.PostgresArchive)(unsafe.Pointer(in.Archive))
...
func autoConvert_kubedb_PostgresSpec_To_v1alpha1_PostgresSpec(in *kubedb.PostgresSpec, out *PostgresSpec, s conversion.Scope) error {
	...
	out.Archive = (*PostgresArchive)(unsafe.Pointer(in.Archive))
	out.Restore = in.Restore
	out.Storage = (*core_v1.PersistentVolumeClaimSpec)(unsafe.Pointer(in.Storage))
	out.NodeSelector = *(*map[string]string)(unsafe.Pointer(&in.NodeSelector))
	out.Init = (*InitSpec)(unsafe.Pointer(in.Init))
