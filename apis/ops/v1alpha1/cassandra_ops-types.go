...
const (
	ResourceCodeCassandraOpsRequest     = "chops"
...
// +kubebuilder:resource:path=cassandraopsrequests,singular=cassandraopsrequest,shortName=chops,categories={ops,kubedb,appscode}
