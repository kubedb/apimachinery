...
func (in *ClickHouseOpsRequestSpec) DeepCopyInto(out *ClickHouseOpsRequestSpec) {
	*out = *in
	...
	if in.Configuration != nil {
		in, out := &in.Configuration, &out.Configuration
		*out = new(ClickHouseReconfigurationSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Timeout != nil {
		in, out := &in.Timeout, &out.Timeout
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClickHouseReconfigurationSpec) DeepCopyInto(out *ClickHouseReconfigurationSpec) {
	*out = *in
	if in.ConfigSecret != nil {
		in, out := &in.ConfigSecret, &out.ConfigSecret
		*out = new(v1.LocalObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClickHouseReconfigurationSpec.
func (in *ClickHouseReconfigurationSpec) DeepCopy() *ClickHouseReconfigurationSpec {
	if in == nil {
		return nil
	}
	out := new(ClickHouseReconfigurationSpec)
...
func (in *MSSQLServerOpsRequestSpec) DeepCopyInto(out *MSSQLServerOpsRequestSpec) {
	*out = *in
	...
	if in.Configuration != nil {
		in, out := &in.Configuration, &out.Configuration
		*out = new(MSSQLServerReconfigurationSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.TLS != nil {
		in, out := &in.TLS, &out.TLS
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MSSQLServerReconfigurationSpec) DeepCopyInto(out *MSSQLServerReconfigurationSpec) {
	*out = *in
	if in.ConfigSecret != nil {
		in, out := &in.ConfigSecret, &out.ConfigSecret
		*out = new(v1.LocalObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MSSQLServerReconfigurationSpec.
func (in *MSSQLServerReconfigurationSpec) DeepCopy() *MSSQLServerReconfigurationSpec {
	if in == nil {
		return nil
	}
	out := new(MSSQLServerReconfigurationSpec)
