...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HanaDBMigrationSpec) DeepCopyInto(out *HanaDBMigrationSpec) {
	*out = *in
	if in.StorageClassName != nil {
		in, out := &in.StorageClassName, &out.StorageClassName
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HanaDBMigrationSpec.
func (in *HanaDBMigrationSpec) DeepCopy() *HanaDBMigrationSpec {
	if in == nil {
		return nil
	}
	out := new(HanaDBMigrationSpec)
	in.DeepCopyInto(out)
	return out
}
