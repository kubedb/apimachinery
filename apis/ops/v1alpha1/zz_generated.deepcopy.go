...
func (in *PostgresOpsRequestSpec) DeepCopyInto(out *PostgresOpsRequestSpec) {
	*out = *in
	...
	if in.RecoverWithDataLoss != nil {
		in, out := &in.RecoverWithDataLoss, &out.RecoverWithDataLoss
		*out = new(PostgresRecoveryWithDataLoss)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PostgresRecoveryWithDataLoss) DeepCopyInto(out *PostgresRecoveryWithDataLoss) {
	*out = *in
	if in.ReadyTimeOut != nil {
		in, out := &in.ReadyTimeOut, &out.ReadyTimeOut
		*out = new(metav1.Duration)
	...
	if in.AcceptDataLoss != nil {
		in, out := &in.AcceptDataLoss, &out.AcceptDataLoss
		*out = new(bool)
		**out = **in
	}
	if in.PrimaryPodName != nil {
		in, out := &in.PrimaryPodName, &out.PrimaryPodName
		*out = new(string)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostgresRecoveryWithDataLoss.
func (in *PostgresRecoveryWithDataLoss) DeepCopy() *PostgresRecoveryWithDataLoss {
	if in == nil {
		return nil
	}
	out := new(PostgresRecoveryWithDataLoss)
