...
func (in *RedisHorizontalScalingSpec) DeepCopyInto(out *RedisHorizontalScalingSpec) {
	*out = *in
	...
	if in.DataCenters != nil {
		in, out := &in.DataCenters, &out.DataCenters
		*out = make([]RedisHorizontalScalingDC, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisHorizontalScalingDC) DeepCopyInto(out *RedisHorizontalScalingDC) {
	*out = *in
	if in.Replicas != nil {
		in, out := &in.Replicas, &out.Replicas
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisHorizontalScalingDC.
func (in *RedisHorizontalScalingDC) DeepCopy() *RedisHorizontalScalingDC {
	if in == nil {
		return nil
	}
	out := new(RedisHorizontalScalingDC)
	in.DeepCopyInto(out)
	return out
}
