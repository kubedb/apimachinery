...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticsearchLicenseOpsSpec) DeepCopyInto(out *ElasticsearchLicenseOpsSpec) {
	*out = *in
	if in.SecretRef != nil {
		in, out := &in.SecretRef, &out.SecretRef
		*out = new(corev1.LocalObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticsearchLicenseOpsSpec.
func (in *ElasticsearchLicenseOpsSpec) DeepCopy() *ElasticsearchLicenseOpsSpec {
	if in == nil {
		return nil
	}
	out := new(ElasticsearchLicenseOpsSpec)
	in.DeepCopyInto(out)
	return out
}
