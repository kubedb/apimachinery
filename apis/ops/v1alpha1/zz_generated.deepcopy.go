...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SinglestoreReplicaReadinessCriteria) DeepCopyInto(out *SinglestoreReplicaReadinessCriteria) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SinglestoreReplicaReadinessCriteria.
func (in *SinglestoreReplicaReadinessCriteria) DeepCopy() *SinglestoreReplicaReadinessCriteria {
	if in == nil {
		return nil
	}
	out := new(SinglestoreReplicaReadinessCriteria)
	in.DeepCopyInto(out)
	return out
}
