...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MilvusMigrationSpec) DeepCopyInto(out *MilvusMigrationSpec) {
	*out = *in
	if in.StorageClassName != nil {
		in, out := &in.StorageClassName, &out.StorageClassName
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MilvusMigrationSpec.
func (in *MilvusMigrationSpec) DeepCopy() *MilvusMigrationSpec {
	if in == nil {
		return nil
	}
	out := new(MilvusMigrationSpec)
	in.DeepCopyInto(out)
	return out
}
