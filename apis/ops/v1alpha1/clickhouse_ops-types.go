...
type ClickHouseOpsRequestSpec struct {
	...
	Configuration *ClickHouseReconfigurationSpec `json:"configuration,omitempty"`
...
// ClickHouseReconfigurationSpec is the spec for Reconfiguring the clickhouse Settings
type ClickHouseReconfigurationSpec struct {
