...
const (
	...
	// EtcdOpsRequestTypeStorageMigration is a EtcdOpsRequestType of type StorageMigration.
	EtcdOpsRequestTypeStorageMigration EtcdOpsRequestType = "StorageMigration"
	// EtcdOpsRequestTypeMoveLeader is a EtcdOpsRequestType of type MoveLeader.
	EtcdOpsRequestTypeMoveLeader EtcdOpsRequestType = "MoveLeader"
	// EtcdOpsRequestTypeDefragment is a EtcdOpsRequestType of type Defragment.
...
var _EtcdOpsRequestTypeNames = []string{
	...
	string(EtcdOpsRequestTypeStorageMigration),
...
func EtcdOpsRequestTypeValues() []EtcdOpsRequestType {
	return []EtcdOpsRequestType{
		...
		EtcdOpsRequestTypeStorageMigration,
