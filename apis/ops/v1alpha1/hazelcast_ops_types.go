...
// HazelcastOpsRequest defines a Hazelcast DBA operation.
...
type HazelcastOpsRequestSpec struct {
	// Specifies the Hazelcast reference
...
// HazelcastReplicaReadinessCriteria is the criteria for checking readiness of an Hazelcast database
type HazelcastReplicaReadinessCriteria struct{}
...
// HazelcastHorizontalScalingSpec contains the horizontal scaling information of an Hazelcast cluster
type HazelcastHorizontalScalingSpec struct {
	// Number of combined (i.e. master, data, ingest) node
	Node *int32 `json:"node,omitempty"`
}

// HazelcastVerticalScalingSpec is the spec for Hazelcast vertical scaling
type HazelcastVerticalScalingSpec struct {
	// Resource spec for combined nodes
	Node *PodResources `json:"node,omitempty"`
}

// HazelcastVolumeExpansionSpec is the spec for Hazelcast volume expansion
