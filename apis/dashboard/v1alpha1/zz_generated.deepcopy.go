...
import (
	...
	client_goapiv1 "kmodules.xyz/client-go/api/v1"
	apiv1 "kmodules.xyz/monitoring-agent-api/api/v1"
)

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertSecrets) DeepCopyInto(out *CertSecrets) {
	*out = *in
	if in.Ca != nil {
		in, out := &in.Ca, &out.Ca
		*out = new(v1.Secret)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertSecrets.
func (in *CertSecrets) DeepCopy() *CertSecrets {
	if in == nil {
		return nil
	}
	out := new(CertSecrets)
...
func (in *ElasticsearchDashboardSpec) DeepCopyInto(out *ElasticsearchDashboardSpec) {
	*out = *in
	...
	if in.TLS != nil {
		...
		*out = new(client_goapiv1.TLSConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ElasticsearchDashboardStatus) DeepCopyInto(out *ElasticsearchDashboardStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]client_goapiv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
