...
type Source struct {
	...
	// Mongo refers to the source MongoDB database configuration
...
type Target struct {
	...
	// Mongo refers to the target MongoDB database configuration
	Mongo *MongoTarget `yaml:"mongo" json:"mongo,omitempty"`
}
