...
// EtcdAutoscaler is the configuration for an Etcd database
...
type EtcdAutoscaler struct {
	...
	Spec EtcdAutoscalerSpec `json:"spec"`
...
// EtcdAutoscalerSpec is the specification of the behavior of the autoscaler.
type EtcdAutoscalerSpec struct {
	...
	Compute *EtcdComputeAutoscalerSpec `json:"compute,omitempty"`
	Storage *EtcdStorageAutoscalerSpec `json:"storage,omitempty"`
}

type EtcdComputeAutoscalerSpec struct {
	// +optional
	NodeTopology *NodeTopology `json:"nodeTopology,omitempty"`

	Etcd *ComputeAutoscalerSpec `json:"etcd,omitempty"`
}

type EtcdStorageAutoscalerSpec struct {
	Etcd *StorageAutoscalerSpec `json:"etcd,omitempty"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// EtcdAutoscalerList is a list of EtcdAutoscaler objects.
type EtcdAutoscalerList struct {
	...
	// items is the list of Etcd database autoscaler objects.
