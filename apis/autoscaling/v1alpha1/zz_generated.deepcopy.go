...
func (in *QdrantAutoscalerSpec) DeepCopyInto(out *QdrantAutoscalerSpec) {
	*out = *in
	...
	if in.OpsRequestOptions != nil {
		in, out := &in.OpsRequestOptions, &out.OpsRequestOptions
		*out = new(QdrantOpsRequestOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.Compute != nil {
		in, out := &in.Compute, &out.Compute
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QdrantOpsRequestOptions) DeepCopyInto(out *QdrantOpsRequestOptions) {
	*out = *in
	if in.ReadinessCriteria != nil {
		in, out := &in.ReadinessCriteria, &out.ReadinessCriteria
		*out = new(opsv1alpha1.QdrantReplicaReadinessCriteria)
		**out = **in
	}
	if in.Timeout != nil {
		in, out := &in.Timeout, &out.Timeout
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QdrantOpsRequestOptions.
func (in *QdrantOpsRequestOptions) DeepCopy() *QdrantOpsRequestOptions {
	if in == nil {
		return nil
	}
	out := new(QdrantOpsRequestOptions)
