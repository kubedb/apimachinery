...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModel":         schema_resource_metadata_apis_editor_v1alpha1_EditorModel(ref),
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelRequest":  schema_resource_metadata_apis_editor_v1alpha1_EditorModelRequest(ref),
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelResource": schema_resource_metadata_apis_editor_v1alpha1_EditorModelResource(ref),
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelResponse": schema_resource_metadata_apis_editor_v1alpha1_EditorModelResponse(ref),
...
func schema_resource_metadata_apis_editor_v1alpha1_EditorModel(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "EditorModel loads the editor model, manifest and resources for an existing installation identified by its metadata. It is the aggregated-API equivalent of kubepack.dev/lib-app/pkg/editor.LoadResourceEditorModel (see chart_template.go loadEditorModel2).",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"request": {
						SchemaProps: spec.SchemaProps{
							Description: "Request identifies the installation to load.",
							Ref:         ref("kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelRequest"),
						},
					},
					"response": {
						SchemaProps: spec.SchemaProps{
							Description: "Response holds the loaded editor template.",
							Ref:         ref("kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelResponse"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelRequest", "kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelResponse"},
	}
}

func schema_resource_metadata_apis_editor_v1alpha1_EditorModelRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_metadata_apis_editor_v1alpha1_EditorModelResource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_metadata_apis_editor_v1alpha1_EditorModelResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"manifest": {
						SchemaProps: spec.SchemaProps{
							Description: "Manifest is the rendered manifest of the existing installation.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"values": {
						SchemaProps: spec.SchemaProps{
							Description: "Values is the editor model (values) of the existing installation.",
							Ref:         ref("k8s.io/apimachinery/pkg/runtime.RawExtension"),
						},
					},
					"resources": {
						SchemaProps: spec.SchemaProps{
							Description: "Resources holds the individual resources of the existing installation.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelResource"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/runtime.RawExtension", "kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorModelResource"},
	}
}
