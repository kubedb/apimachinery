...
<<<<<<< HEAD:vendor/kmodules.xyz/custom-resources/apis/metrics/v1alpha1/metricsconfiguration_helpers.go
import (
...
package v1alpha1
>>>>>>> rebased:vendor/stash.appscode.dev/apimachinery/client/clientset/versioned/typed/ui/v1alpha1/doc.go
