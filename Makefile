...
CORE_API_GROUPS      ?= kubedb:v1alpha1 kubedb:v1alpha2 kubedb:v1beta1 postgres:v1alpha1 catalog:v1alpha1 config:v1alpha1 ops:v1alpha1 autoscaling:v1alpha1 elasticsearch:v1alpha1 schema:v1alpha1 archiver:v1alpha1 kafka:v1alpha1
...
gen-conversion:
	@docker run --rm                                   \
		...
		/go/bin/conversion-gen --go-header-file ./hack/license/go.txt \
			--input-dirs $(GO_PKG)/$(REPO)/apis/kubedb/v1beta1 \
