...
func defaultMemcachedInformer(client client.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewMemcachedInformer(client, v1.NamespaceAll, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
}

func (f *memcachedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedb_v1alpha1.Memcached{}, defaultMemcachedInformer)
}
