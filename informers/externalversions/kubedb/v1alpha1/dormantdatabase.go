...
func defaultDormantDatabaseInformer(client client.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewDormantDatabaseInformer(client, v1.NamespaceAll, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
}

func (f *dormantDatabaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedb_v1alpha1.DormantDatabase{}, defaultDormantDatabaseInformer)
}
