...
func newDormantDatabaseInformer(client client.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.KubedbV1alpha1().DormantDatabases(v1.NamespaceAll).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.KubedbV1alpha1().DormantDatabases(v1.NamespaceAll).Watch(options)
			},
		},
...
func (f *dormantDatabaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedb_v1alpha1.DormantDatabase{}, newDormantDatabaseInformer)
}
