...
type DormantDatabaseLister interface {
	...
	List(selector labels.Selector) (ret []*kubedb.DormantDatabase, err error)
...
// List lists all DormantDatabases in the indexer.
func (s *dormantDatabaseLister) List(selector labels.Selector) (ret []*kubedb.DormantDatabase, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*kubedb.DormantDatabase))
	})
	return ret, err
}
...
type DormantDatabaseNamespaceLister interface {
	...
	Get(name string) (*kubedb.DormantDatabase, error)
...
// List lists all DormantDatabases in the indexer for a given namespace.
func (s dormantDatabaseNamespaceLister) List(selector labels.Selector) (ret []*kubedb.DormantDatabase, err error) {
...
// Get retrieves the DormantDatabase from the indexer for a given namespace and name.
func (s dormantDatabaseNamespaceLister) Get(name string) (*kubedb.DormantDatabase, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(kubedb.Resource("dormantdatabase"), name)
	}
	return obj.(*kubedb.DormantDatabase), nil
}
