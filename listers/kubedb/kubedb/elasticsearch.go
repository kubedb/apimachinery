...
// Get retrieves the Elasticsearch from the indexer for a given namespace and name.
func (s elasticsearchNamespaceLister) Get(name string) (*kubedb.Elasticsearch, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(kubedb.Resource("elasticsearch"), name)
	}
	return obj.(*kubedb.Elasticsearch), nil
}
