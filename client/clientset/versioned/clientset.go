...
type Interface interface {
	...
	KubedbV1beta1() kubedbv1beta1.KubedbV1beta1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	kubedbV1beta1         *kubedbv1beta1.KubedbV1beta1Client
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.kubedbV1beta1, err = kubedbv1beta1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.kubedbV1beta1 = kubedbv1beta1.New(c)
