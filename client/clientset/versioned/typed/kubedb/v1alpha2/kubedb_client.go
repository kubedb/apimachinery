...
func (c *KubedbV1alpha2Client) Publishers(namespace string) PublisherInterface {
...
func (c *KubedbV1alpha2Client) Subscribers(namespace string) SubscriberInterface {
