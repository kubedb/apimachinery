...
var redisesResource = schema.GroupVersionResource{Group: "kubedb.com", Version: "v1alpha2", Resource: "redises"}

var redisesKind = schema.GroupVersionKind{Group: "kubedb.com", Version: "v1alpha2", Kind: "Redis"}
...
func (c *FakeRedises) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Redis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(redisesResource, c.ns, name), &v1alpha2.Redis{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.Redis), err
}
...
func (c *FakeRedises) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.RedisList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(redisesResource, redisesKind, c.ns, opts), &v1alpha2.RedisList{})
	...
	list := &v1alpha2.RedisList{ListMeta: obj.(*v1alpha2.RedisList).ListMeta}
	for _, item := range obj.(*v1alpha2.RedisList).Items {
...
func (c *FakeRedises) Create(ctx context.Context, redis *v1alpha2.Redis, opts v1.CreateOptions) (result *v1alpha2.Redis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(redisesResource, c.ns, redis), &v1alpha2.Redis{})
...
func (c *FakeRedises) Update(ctx context.Context, redis *v1alpha2.Redis, opts v1.UpdateOptions) (result *v1alpha2.Redis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(redisesResource, c.ns, redis), &v1alpha2.Redis{})
...
func (c *FakeRedises) UpdateStatus(ctx context.Context, redis *v1alpha2.Redis, opts v1.UpdateOptions) (*v1alpha2.Redis, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(redisesResource, "status", c.ns, redis), &v1alpha2.Redis{})
...
func (c *FakeRedises) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha2.RedisList{})
	return err
}
...
func (c *FakeRedises) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Redis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(redisesResource, c.ns, name, pt, data, subresources...), &v1alpha2.Redis{})
