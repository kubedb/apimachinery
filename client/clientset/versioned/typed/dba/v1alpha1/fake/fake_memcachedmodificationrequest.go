...
var memcachedmodificationrequestsKind = schema.GroupVersionKind{Group: "dba.kubedb.com", Version: "v1alpha1", Kind: "MemcachedModificationRequest"}
...
func (c *FakeMemcachedModificationRequests) List(opts v1.ListOptions) (result *v1alpha1.MemcachedModificationRequestList, err error) {
	...
	list := &v1alpha1.MemcachedModificationRequestList{ListMeta: obj.(*v1alpha1.MemcachedModificationRequestList).ListMeta}
	for _, item := range obj.(*v1alpha1.MemcachedModificationRequestList).Items {
