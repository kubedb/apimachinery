...
type PgBouncerModificationRequestInterface interface {
	...
	List(opts v1.ListOptions) (*v1alpha1.PgBouncerModificationRequestList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PgBouncerModificationRequest, err error)
	PgBouncerModificationRequestExpansion
}
...
func (c *pgBouncerModificationRequests) List(opts v1.ListOptions) (result *v1alpha1.PgBouncerModificationRequestList, err error) {
...
func (c *pgBouncerModificationRequests) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pgBouncerModificationRequests) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
