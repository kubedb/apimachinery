...
var elasticsearchversionsResource = v1alpha1.SchemeGroupVersion.WithResource("elasticsearchversions")

var elasticsearchversionsKind = v1alpha1.SchemeGroupVersion.WithKind("ElasticsearchVersion")
