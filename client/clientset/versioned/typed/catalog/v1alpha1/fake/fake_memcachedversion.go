...
var memcachedversionsResource = v1alpha1.SchemeGroupVersion.WithResource("memcachedversions")

var memcachedversionsKind = v1alpha1.SchemeGroupVersion.WithKind("MemcachedVersion")
