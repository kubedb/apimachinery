...
var perconaxtradbopsrequestsResource = v1alpha1.SchemeGroupVersion.WithResource("perconaxtradbopsrequests")

var perconaxtradbopsrequestsKind = v1alpha1.SchemeGroupVersion.WithKind("PerconaXtraDBOpsRequest")
