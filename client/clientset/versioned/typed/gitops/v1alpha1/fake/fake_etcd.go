...
var etcdsResource = v1alpha1.SchemeGroupVersion.WithResource("etcds")

var etcdsKind = v1alpha1.SchemeGroupVersion.WithKind("Etcd")
...
func (c *FakeEtcds) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(etcdsResource, c.ns, name, opts), &v1alpha1.Etcd{})
