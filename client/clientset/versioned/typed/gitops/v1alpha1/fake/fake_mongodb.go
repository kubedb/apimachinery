...
var mongodbsResource = v1alpha1.SchemeGroupVersion.WithResource("mongodbs")

var mongodbsKind = v1alpha1.SchemeGroupVersion.WithKind("MongoDB")
...
func (c *FakeMongoDBs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(mongodbsResource, c.ns, name, opts), &v1alpha1.MongoDB{})
