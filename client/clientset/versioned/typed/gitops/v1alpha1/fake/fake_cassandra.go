...
var cassandrasResource = v1alpha1.SchemeGroupVersion.WithResource("cassandras")

var cassandrasKind = v1alpha1.SchemeGroupVersion.WithKind("Cassandra")

// Get takes name of the cassandra, and returns the corresponding cassandra object, and an error if there is any.
func (c *FakeCassandras) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Cassandra, err error) {
	obj, err := c.Fake.
...
func (c *FakeCassandras) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CassandraList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCassandras) Create(ctx context.Context, cassandra *v1alpha1.Cassandra, opts v1.CreateOptions) (result *v1alpha1.Cassandra, err error) {
	obj, err := c.Fake.
...
func (c *FakeCassandras) Update(ctx context.Context, cassandra *v1alpha1.Cassandra, opts v1.UpdateOptions) (result *v1alpha1.Cassandra, err error) {
	obj, err := c.Fake.
...
func (c *FakeCassandras) UpdateStatus(ctx context.Context, cassandra *v1alpha1.Cassandra, opts v1.UpdateOptions) (*v1alpha1.Cassandra, error) {
	obj, err := c.Fake.
...
func (c *FakeCassandras) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(cassandrasResource, c.ns, name, opts), &v1alpha1.Cassandra{})
...
func (c *FakeCassandras) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Cassandra, err error) {
	obj, err := c.Fake.
