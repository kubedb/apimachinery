...
var elasticsearchesResource = v1alpha1.SchemeGroupVersion.WithResource("elasticsearches")

var elasticsearchesKind = v1alpha1.SchemeGroupVersion.WithKind("Elasticsearch")
...
func (c *FakeElasticsearches) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(elasticsearchesResource, c.ns, name, opts), &v1alpha1.Elasticsearch{})
