...
var pgbouncersResource = v1alpha1.SchemeGroupVersion.WithResource("pgbouncers")

var pgbouncersKind = v1alpha1.SchemeGroupVersion.WithKind("PgBouncer")
...
func (c *FakePgBouncers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(pgbouncersResource, c.ns, name, opts), &v1alpha1.PgBouncer{})
