...
type MongoDBInterface interface {
	Create(*kubedb.MongoDB) (*kubedb.MongoDB, error)
	Update(*kubedb.MongoDB) (*kubedb.MongoDB, error)
	UpdateStatus(*kubedb.MongoDB) (*kubedb.MongoDB, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*kubedb.MongoDB, error)
	List(opts v1.ListOptions) (*kubedb.MongoDBList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubedb.MongoDB, err error)
	MongoDBExpansion
}
...
func newMongoDBs(c *KubedbClient, namespace string) *mongoDBs {
	return &mongoDBs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mongoDBs) Get(name string, options v1.GetOptions) (result *kubedb.MongoDB, err error) {
	result = &kubedb.MongoDB{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mongodbs").
		Name(name).
...
func (c *mongoDBs) List(opts v1.ListOptions) (result *kubedb.MongoDBList, err error) {
	result = &kubedb.MongoDBList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mongodbs").
...
func (c *mongoDBs) Create(mongoDB *kubedb.MongoDB) (result *kubedb.MongoDB, err error) {
	result = &kubedb.MongoDB{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mongodbs").
...
func (c *mongoDBs) Update(mongoDB *kubedb.MongoDB) (result *kubedb.MongoDB, err error) {
	result = &kubedb.MongoDB{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbs").
...
func (c *mongoDBs) UpdateStatus(mongoDB *kubedb.MongoDB) (result *kubedb.MongoDB, err error) {
	result = &kubedb.MongoDB{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbs").
...
func (c *mongoDBs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubedb.MongoDB, err error) {
	result = &kubedb.MongoDB{}
