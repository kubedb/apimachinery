...
type MemcachedInterface interface {
	Create(*kubedb.Memcached) (*kubedb.Memcached, error)
	Update(*kubedb.Memcached) (*kubedb.Memcached, error)
	UpdateStatus(*kubedb.Memcached) (*kubedb.Memcached, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*kubedb.Memcached, error)
	List(opts v1.ListOptions) (*kubedb.MemcachedList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubedb.Memcached, err error)
	MemcachedExpansion
}
...
func newMemcacheds(c *KubedbClient, namespace string) *memcacheds {
	return &memcacheds{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *memcacheds) Get(name string, options v1.GetOptions) (result *kubedb.Memcached, err error) {
	result = &kubedb.Memcached{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("memcacheds").
		Name(name).
...
func (c *memcacheds) List(opts v1.ListOptions) (result *kubedb.MemcachedList, err error) {
	result = &kubedb.MemcachedList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("memcacheds").
...
func (c *memcacheds) Create(memcached *kubedb.Memcached) (result *kubedb.Memcached, err error) {
	result = &kubedb.Memcached{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("memcacheds").
...
func (c *memcacheds) Update(memcached *kubedb.Memcached) (result *kubedb.Memcached, err error) {
	result = &kubedb.Memcached{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("memcacheds").
...
func (c *memcacheds) UpdateStatus(memcached *kubedb.Memcached) (result *kubedb.Memcached, err error) {
	result = &kubedb.Memcached{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("memcacheds").
...
func (c *memcacheds) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubedb.Memcached, err error) {
	result = &kubedb.Memcached{}
