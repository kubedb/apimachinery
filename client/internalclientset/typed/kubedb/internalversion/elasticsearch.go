...
type ElasticsearchInterface interface {
	Create(*kubedb.Elasticsearch) (*kubedb.Elasticsearch, error)
	Update(*kubedb.Elasticsearch) (*kubedb.Elasticsearch, error)
	UpdateStatus(*kubedb.Elasticsearch) (*kubedb.Elasticsearch, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*kubedb.Elasticsearch, error)
	List(opts v1.ListOptions) (*kubedb.ElasticsearchList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubedb.Elasticsearch, err error)
...
func newElasticsearches(c *KubedbClient, namespace string) *elasticsearches {
...
func (c *elasticsearches) Get(name string, options v1.GetOptions) (result *kubedb.Elasticsearch, err error) {
	result = &kubedb.Elasticsearch{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *elasticsearches) List(opts v1.ListOptions) (result *kubedb.ElasticsearchList, err error) {
	result = &kubedb.ElasticsearchList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("elasticsearches").
...
func (c *elasticsearches) Create(elasticsearch *kubedb.Elasticsearch) (result *kubedb.Elasticsearch, err error) {
	result = &kubedb.Elasticsearch{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("elasticsearches").
...
func (c *elasticsearches) Update(elasticsearch *kubedb.Elasticsearch) (result *kubedb.Elasticsearch, err error) {
	result = &kubedb.Elasticsearch{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticsearches").
...
func (c *elasticsearches) UpdateStatus(elasticsearch *kubedb.Elasticsearch) (result *kubedb.Elasticsearch, err error) {
	result = &kubedb.Elasticsearch{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticsearches").
...
func (c *elasticsearches) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubedb.Elasticsearch, err error) {
	result = &kubedb.Elasticsearch{}
