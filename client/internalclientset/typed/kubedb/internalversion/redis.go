...
type RedisInterface interface {
	Create(*kubedb.Redis) (*kubedb.Redis, error)
	Update(*kubedb.Redis) (*kubedb.Redis, error)
	UpdateStatus(*kubedb.Redis) (*kubedb.Redis, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*kubedb.Redis, error)
	List(opts v1.ListOptions) (*kubedb.RedisList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubedb.Redis, err error)
	RedisExpansion
}
...
func newRedises(c *KubedbClient, namespace string) *redises {
	return &redises{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *redises) Get(name string, options v1.GetOptions) (result *kubedb.Redis, err error) {
	result = &kubedb.Redis{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("redises").
...
func (c *redises) List(opts v1.ListOptions) (result *kubedb.RedisList, err error) {
	result = &kubedb.RedisList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("redises").
...
func (c *redises) Create(redis *kubedb.Redis) (result *kubedb.Redis, err error) {
	result = &kubedb.Redis{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("redises").
...
func (c *redises) Update(redis *kubedb.Redis) (result *kubedb.Redis, err error) {
	result = &kubedb.Redis{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redises").
...
func (c *redises) UpdateStatus(redis *kubedb.Redis) (result *kubedb.Redis, err error) {
	result = &kubedb.Redis{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redises").
...
func (c *redises) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubedb.Redis, err error) {
	result = &kubedb.Redis{}
