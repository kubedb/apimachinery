...
type RedisOpsRequestLister interface {
	...
	List(selector labels.Selector) (ret []*opsv1alpha1.RedisOpsRequest, err error)
...
type redisOpsRequestLister struct {
	listers.ResourceIndexer[*opsv1alpha1.RedisOpsRequest]
}
...
func NewRedisOpsRequestLister(indexer cache.Indexer) RedisOpsRequestLister {
	return &redisOpsRequestLister{listers.New[*opsv1alpha1.RedisOpsRequest](indexer, opsv1alpha1.Resource("redisopsrequest"))}
}

// RedisOpsRequests returns an object that can list and get RedisOpsRequests.
func (s *redisOpsRequestLister) RedisOpsRequests(namespace string) RedisOpsRequestNamespaceLister {
	return redisOpsRequestNamespaceLister{listers.NewNamespaced[*opsv1alpha1.RedisOpsRequest](s.ResourceIndexer, namespace)}
}
...
type RedisOpsRequestNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*opsv1alpha1.RedisOpsRequest, error)
