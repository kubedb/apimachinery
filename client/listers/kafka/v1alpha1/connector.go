...
// List lists all Connectors in the indexer for a given namespace.
func (s connectorNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.Connector, err error) {
...
// Get retrieves the Connector from the indexer for a given namespace and name.
func (s connectorNamespaceLister) Get(name string) (*v1alpha1.Connector, error) {
