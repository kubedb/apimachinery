...
type HazelcastLister interface {
	...
	List(selector labels.Selector) (ret []*kubedbv1alpha2.Hazelcast, err error)
...
type hazelcastLister struct {
	listers.ResourceIndexer[*kubedbv1alpha2.Hazelcast]
}

// NewHazelcastLister returns a new HazelcastLister.
func NewHazelcastLister(indexer cache.Indexer) HazelcastLister {
	return &hazelcastLister{listers.New[*kubedbv1alpha2.Hazelcast](indexer, kubedbv1alpha2.Resource("hazelcast"))}
}

// Hazelcasts returns an object that can list and get Hazelcasts.
func (s *hazelcastLister) Hazelcasts(namespace string) HazelcastNamespaceLister {
	return hazelcastNamespaceLister{listers.NewNamespaced[*kubedbv1alpha2.Hazelcast](s.ResourceIndexer, namespace)}
}
...
type HazelcastNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kubedbv1alpha2.Hazelcast, error)
