...
type Neo4jLister interface {
	...
	List(selector labels.Selector) (ret []*kubedbv1alpha2.Neo4j, err error)
...
type neo4jLister struct {
	listers.ResourceIndexer[*kubedbv1alpha2.Neo4j]
}

// NewNeo4jLister returns a new Neo4jLister.
func NewNeo4jLister(indexer cache.Indexer) Neo4jLister {
	return &neo4jLister{listers.New[*kubedbv1alpha2.Neo4j](indexer, kubedbv1alpha2.Resource("neo4j"))}
}

// Neo4js returns an object that can list and get Neo4js.
func (s *neo4jLister) Neo4js(namespace string) Neo4jNamespaceLister {
	return neo4jNamespaceLister{listers.NewNamespaced[*kubedbv1alpha2.Neo4j](s.ResourceIndexer, namespace)}
}
...
type Neo4jNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kubedbv1alpha2.Neo4j, error)
