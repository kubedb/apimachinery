...
type RedisSentinelLister interface {
	...
	List(selector labels.Selector) (ret []*kubedbv1alpha2.RedisSentinel, err error)
...
type redisSentinelLister struct {
	listers.ResourceIndexer[*kubedbv1alpha2.RedisSentinel]
}
...
func NewRedisSentinelLister(indexer cache.Indexer) RedisSentinelLister {
	return &redisSentinelLister{listers.New[*kubedbv1alpha2.RedisSentinel](indexer, kubedbv1alpha2.Resource("redissentinel"))}
}

// RedisSentinels returns an object that can list and get RedisSentinels.
func (s *redisSentinelLister) RedisSentinels(namespace string) RedisSentinelNamespaceLister {
	return redisSentinelNamespaceLister{listers.NewNamespaced[*kubedbv1alpha2.RedisSentinel](s.ResourceIndexer, namespace)}
}
...
type RedisSentinelNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kubedbv1alpha2.RedisSentinel, error)
