...
type IgniteLister interface {
	...
	List(selector labels.Selector) (ret []*gitopsv1alpha1.Ignite, err error)
...
type igniteLister struct {
	listers.ResourceIndexer[*gitopsv1alpha1.Ignite]
}

// NewIgniteLister returns a new IgniteLister.
func NewIgniteLister(indexer cache.Indexer) IgniteLister {
	return &igniteLister{listers.New[*gitopsv1alpha1.Ignite](indexer, gitopsv1alpha1.Resource("ignite"))}
}

// Ignites returns an object that can list and get Ignites.
func (s *igniteLister) Ignites(namespace string) IgniteNamespaceLister {
	return igniteNamespaceLister{listers.NewNamespaced[*gitopsv1alpha1.Ignite](s.ResourceIndexer, namespace)}
}
...
type IgniteNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*gitopsv1alpha1.Ignite, error)
