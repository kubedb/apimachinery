...
type PgpoolLister interface {
	...
	List(selector labels.Selector) (ret []*gitopsv1alpha1.Pgpool, err error)
...
type pgpoolLister struct {
	listers.ResourceIndexer[*gitopsv1alpha1.Pgpool]
}

// NewPgpoolLister returns a new PgpoolLister.
func NewPgpoolLister(indexer cache.Indexer) PgpoolLister {
	return &pgpoolLister{listers.New[*gitopsv1alpha1.Pgpool](indexer, gitopsv1alpha1.Resource("pgpool"))}
}

// Pgpools returns an object that can list and get Pgpools.
func (s *pgpoolLister) Pgpools(namespace string) PgpoolNamespaceLister {
	return pgpoolNamespaceLister{listers.NewNamespaced[*gitopsv1alpha1.Pgpool](s.ResourceIndexer, namespace)}
}
...
type PgpoolNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*gitopsv1alpha1.Pgpool, error)
