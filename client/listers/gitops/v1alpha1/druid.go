...
type DruidLister interface {
	...
	List(selector labels.Selector) (ret []*gitopsv1alpha1.Druid, err error)
...
type druidLister struct {
	listers.ResourceIndexer[*gitopsv1alpha1.Druid]
}

// NewDruidLister returns a new DruidLister.
func NewDruidLister(indexer cache.Indexer) DruidLister {
	return &druidLister{listers.New[*gitopsv1alpha1.Druid](indexer, gitopsv1alpha1.Resource("druid"))}
}

// Druids returns an object that can list and get Druids.
func (s *druidLister) Druids(namespace string) DruidNamespaceLister {
	return druidNamespaceLister{listers.NewNamespaced[*gitopsv1alpha1.Druid](s.ResourceIndexer, namespace)}
}
...
type DruidNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*gitopsv1alpha1.Druid, error)
