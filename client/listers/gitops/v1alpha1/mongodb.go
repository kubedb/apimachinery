...
type MongoDBLister interface {
	...
	List(selector labels.Selector) (ret []*gitopsv1alpha1.MongoDB, err error)
...
type mongoDBLister struct {
	listers.ResourceIndexer[*gitopsv1alpha1.MongoDB]
}

// NewMongoDBLister returns a new MongoDBLister.
func NewMongoDBLister(indexer cache.Indexer) MongoDBLister {
	return &mongoDBLister{listers.New[*gitopsv1alpha1.MongoDB](indexer, gitopsv1alpha1.Resource("mongodb"))}
}

// MongoDBs returns an object that can list and get MongoDBs.
func (s *mongoDBLister) MongoDBs(namespace string) MongoDBNamespaceLister {
	return mongoDBNamespaceLister{listers.NewNamespaced[*gitopsv1alpha1.MongoDB](s.ResourceIndexer, namespace)}
}
...
type MongoDBNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*gitopsv1alpha1.MongoDB, error)
