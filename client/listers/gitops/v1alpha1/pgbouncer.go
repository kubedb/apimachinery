...
type PgBouncerLister interface {
	...
	List(selector labels.Selector) (ret []*gitopsv1alpha1.PgBouncer, err error)
...
type pgBouncerLister struct {
	listers.ResourceIndexer[*gitopsv1alpha1.PgBouncer]
}

// NewPgBouncerLister returns a new PgBouncerLister.
func NewPgBouncerLister(indexer cache.Indexer) PgBouncerLister {
	return &pgBouncerLister{listers.New[*gitopsv1alpha1.PgBouncer](indexer, gitopsv1alpha1.Resource("pgbouncer"))}
}

// PgBouncers returns an object that can list and get PgBouncers.
func (s *pgBouncerLister) PgBouncers(namespace string) PgBouncerNamespaceLister {
	return pgBouncerNamespaceLister{listers.NewNamespaced[*gitopsv1alpha1.PgBouncer](s.ResourceIndexer, namespace)}
}
...
type PgBouncerNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*gitopsv1alpha1.PgBouncer, error)
