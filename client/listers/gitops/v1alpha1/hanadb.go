...
type HanaDBLister interface {
	...
	List(selector labels.Selector) (ret []*gitopsv1alpha1.HanaDB, err error)
...
type hanaDBLister struct {
	listers.ResourceIndexer[*gitopsv1alpha1.HanaDB]
}

// NewHanaDBLister returns a new HanaDBLister.
func NewHanaDBLister(indexer cache.Indexer) HanaDBLister {
	return &hanaDBLister{listers.New[*gitopsv1alpha1.HanaDB](indexer, gitopsv1alpha1.Resource("hanadb"))}
}

// HanaDBs returns an object that can list and get HanaDBs.
func (s *hanaDBLister) HanaDBs(namespace string) HanaDBNamespaceLister {
	return hanaDBNamespaceLister{listers.NewNamespaced[*gitopsv1alpha1.HanaDB](s.ResourceIndexer, namespace)}
}
...
type HanaDBNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*gitopsv1alpha1.HanaDB, error)
