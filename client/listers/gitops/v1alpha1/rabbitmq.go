...
type RabbitMQLister interface {
	...
	List(selector labels.Selector) (ret []*gitopsv1alpha1.RabbitMQ, err error)
...
type rabbitMQLister struct {
	listers.ResourceIndexer[*gitopsv1alpha1.RabbitMQ]
}

// NewRabbitMQLister returns a new RabbitMQLister.
func NewRabbitMQLister(indexer cache.Indexer) RabbitMQLister {
	return &rabbitMQLister{listers.New[*gitopsv1alpha1.RabbitMQ](indexer, gitopsv1alpha1.Resource("rabbitmq"))}
}

// RabbitMQs returns an object that can list and get RabbitMQs.
func (s *rabbitMQLister) RabbitMQs(namespace string) RabbitMQNamespaceLister {
	return rabbitMQNamespaceLister{listers.NewNamespaced[*gitopsv1alpha1.RabbitMQ](s.ResourceIndexer, namespace)}
}
...
type RabbitMQNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*gitopsv1alpha1.RabbitMQ, error)
