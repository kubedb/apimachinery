...
type PgBouncerAutoscalerLister interface {
	...
	List(selector labels.Selector) (ret []*autoscalingv1alpha1.PgBouncerAutoscaler, err error)
...
type pgBouncerAutoscalerLister struct {
	listers.ResourceIndexer[*autoscalingv1alpha1.PgBouncerAutoscaler]
}
...
func NewPgBouncerAutoscalerLister(indexer cache.Indexer) PgBouncerAutoscalerLister {
	return &pgBouncerAutoscalerLister{listers.New[*autoscalingv1alpha1.PgBouncerAutoscaler](indexer, autoscalingv1alpha1.Resource("pgbouncerautoscaler"))}
}

// PgBouncerAutoscalers returns an object that can list and get PgBouncerAutoscalers.
func (s *pgBouncerAutoscalerLister) PgBouncerAutoscalers(namespace string) PgBouncerAutoscalerNamespaceLister {
	return pgBouncerAutoscalerNamespaceLister{listers.NewNamespaced[*autoscalingv1alpha1.PgBouncerAutoscaler](s.ResourceIndexer, namespace)}
}
...
type PgBouncerAutoscalerNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*autoscalingv1alpha1.PgBouncerAutoscaler, error)
