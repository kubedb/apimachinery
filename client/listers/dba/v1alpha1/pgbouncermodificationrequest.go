...
// pgBouncerModificationRequestLister implements the PgBouncerModificationRequestLister interface.
type pgBouncerModificationRequestLister struct {
...
func NewPgBouncerModificationRequestLister(indexer cache.Indexer) PgBouncerModificationRequestLister {
	return &pgBouncerModificationRequestLister{indexer: indexer}
}

// List lists all PgBouncerModificationRequests in the indexer.
func (s *pgBouncerModificationRequestLister) List(selector labels.Selector) (ret []*v1alpha1.PgBouncerModificationRequest, err error) {
...
func (s pgBouncerModificationRequestNamespaceLister) Get(name string) (*v1alpha1.PgBouncerModificationRequest, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("pgbouncermodificationrequest"), name)
	}
	return obj.(*v1alpha1.PgBouncerModificationRequest), nil
}
