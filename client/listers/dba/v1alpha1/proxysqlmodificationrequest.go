...
// proxySQLModificationRequestLister implements the ProxySQLModificationRequestLister interface.
type proxySQLModificationRequestLister struct {
...
func NewProxySQLModificationRequestLister(indexer cache.Indexer) ProxySQLModificationRequestLister {
	return &proxySQLModificationRequestLister{indexer: indexer}
}

// List lists all ProxySQLModificationRequests in the indexer.
func (s *proxySQLModificationRequestLister) List(selector labels.Selector) (ret []*v1alpha1.ProxySQLModificationRequest, err error) {
...
func (s proxySQLModificationRequestNamespaceLister) Get(name string) (*v1alpha1.ProxySQLModificationRequest, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("proxysqlmodificationrequest"), name)
	}
	return obj.(*v1alpha1.ProxySQLModificationRequest), nil
}
