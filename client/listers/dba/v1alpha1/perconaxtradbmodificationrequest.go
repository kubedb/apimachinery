...
// perconaXtraDBModificationRequestLister implements the PerconaXtraDBModificationRequestLister interface.
type perconaXtraDBModificationRequestLister struct {
...
func NewPerconaXtraDBModificationRequestLister(indexer cache.Indexer) PerconaXtraDBModificationRequestLister {
	return &perconaXtraDBModificationRequestLister{indexer: indexer}
}

// List lists all PerconaXtraDBModificationRequests in the indexer.
func (s *perconaXtraDBModificationRequestLister) List(selector labels.Selector) (ret []*v1alpha1.PerconaXtraDBModificationRequest, err error) {
...
func (s perconaXtraDBModificationRequestNamespaceLister) Get(name string) (*v1alpha1.PerconaXtraDBModificationRequest, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("perconaxtradbmodificationrequest"), name)
	}
	return obj.(*v1alpha1.PerconaXtraDBModificationRequest), nil
}
