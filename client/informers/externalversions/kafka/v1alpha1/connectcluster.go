...
// ConnectClusterInformer provides access to a shared informer and lister for
// ConnectClusters.
...
// NewConnectClusterInformer constructs a new informer for ConnectCluster type.
...
func NewConnectClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredConnectClusterInformer(client, namespace, resyncPeriod, indexers, nil)
}

// NewFilteredConnectClusterInformer constructs a new informer for ConnectCluster type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *connectClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredConnectClusterInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
