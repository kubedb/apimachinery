...
type KafkaInformer interface {
	...
	Lister() gitopsv1alpha1.KafkaLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().Kafkas(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Kafkas(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Kafkas(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Kafkas(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.Kafka{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kafkaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.Kafka{}, f.defaultInformer)
}

func (f *kafkaInformer) Lister() gitopsv1alpha1.KafkaLister {
	return gitopsv1alpha1.NewKafkaLister(f.Informer().GetIndexer())
}
