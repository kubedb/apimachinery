...
type MariaDBInformer interface {
	...
	Lister() gitopsv1alpha1.MariaDBLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().MariaDBs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().MariaDBs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().MariaDBs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().MariaDBs(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.MariaDB{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mariaDBInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.MariaDB{}, f.defaultInformer)
}

func (f *mariaDBInformer) Lister() gitopsv1alpha1.MariaDBLister {
	return gitopsv1alpha1.NewMariaDBLister(f.Informer().GetIndexer())
}
