...
type ProxySQLInformer interface {
	...
	Lister() gitopsv1alpha1.ProxySQLLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().ProxySQLs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().ProxySQLs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().ProxySQLs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().ProxySQLs(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.ProxySQL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *proxySQLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.ProxySQL{}, f.defaultInformer)
}

func (f *proxySQLInformer) Lister() gitopsv1alpha1.ProxySQLLister {
	return gitopsv1alpha1.NewProxySQLLister(f.Informer().GetIndexer())
}
