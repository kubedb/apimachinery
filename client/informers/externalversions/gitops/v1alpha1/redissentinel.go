...
type RedisSentinelInformer interface {
	...
	Lister() gitopsv1alpha1.RedisSentinelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().RedisSentinels(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().RedisSentinels(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().RedisSentinels(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().RedisSentinels(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.RedisSentinel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisSentinelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.RedisSentinel{}, f.defaultInformer)
}

func (f *redisSentinelInformer) Lister() gitopsv1alpha1.RedisSentinelLister {
	return gitopsv1alpha1.NewRedisSentinelLister(f.Informer().GetIndexer())
}
