...
type MemcachedInformer interface {
	...
	Lister() gitopsv1alpha1.MemcachedLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().Memcacheds(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Memcacheds(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Memcacheds(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Memcacheds(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.Memcached{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *memcachedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.Memcached{}, f.defaultInformer)
}

func (f *memcachedInformer) Lister() gitopsv1alpha1.MemcachedLister {
	return gitopsv1alpha1.NewMemcachedLister(f.Informer().GetIndexer())
}
