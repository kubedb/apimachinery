...
type RedisInformer interface {
	...
	Lister() gitopsv1alpha1.RedisLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().Redises(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Redises(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Redises(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Redises(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.Redis{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.Redis{}, f.defaultInformer)
}

func (f *redisInformer) Lister() gitopsv1alpha1.RedisLister {
	return gitopsv1alpha1.NewRedisLister(f.Informer().GetIndexer())
}
