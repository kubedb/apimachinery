...
type MySQLInformer interface {
	...
	Lister() gitopsv1alpha1.MySQLLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().MySQLs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().MySQLs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().MySQLs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().MySQLs(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.MySQL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mySQLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.MySQL{}, f.defaultInformer)
}

func (f *mySQLInformer) Lister() gitopsv1alpha1.MySQLLister {
	return gitopsv1alpha1.NewMySQLLister(f.Informer().GetIndexer())
}
