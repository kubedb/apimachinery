...
type PerconaXtraDBInformer interface {
	...
	Lister() gitopsv1alpha1.PerconaXtraDBLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().PerconaXtraDBs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().PerconaXtraDBs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().PerconaXtraDBs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().PerconaXtraDBs(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.PerconaXtraDB{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *perconaXtraDBInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.PerconaXtraDB{}, f.defaultInformer)
}

func (f *perconaXtraDBInformer) Lister() gitopsv1alpha1.PerconaXtraDBLister {
	return gitopsv1alpha1.NewPerconaXtraDBLister(f.Informer().GetIndexer())
}
