...
type EtcdInformer interface {
	...
	Lister() gitopsv1alpha1.EtcdLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GitopsV1alpha1().Etcds(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Etcds(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Etcds(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GitopsV1alpha1().Etcds(namespace).Watch(ctx, options)
			},
		},
		&apisgitopsv1alpha1.Etcd{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *etcdInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgitopsv1alpha1.Etcd{}, f.defaultInformer)
}

func (f *etcdInformer) Lister() gitopsv1alpha1.EtcdLister {
	return gitopsv1alpha1.NewEtcdLister(f.Informer().GetIndexer())
}
