...
type RedisSentinelInformer interface {
	...
	Lister() v1beta1.RedisSentinelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().RedisSentinels(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().RedisSentinels(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.RedisSentinel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisSentinelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.RedisSentinel{}, f.defaultInformer)
}

func (f *redisSentinelInformer) Lister() v1beta1.RedisSentinelLister {
	return v1beta1.NewRedisSentinelLister(f.Informer().GetIndexer())
}
