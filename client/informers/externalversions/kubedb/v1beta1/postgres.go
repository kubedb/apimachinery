	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().Postgreses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().Postgreses(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.Postgres{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *postgresInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.Postgres{}, f.defaultInformer)
}

func (f *postgresInformer) Lister() v1beta1.PostgresLister {
	return v1beta1.NewPostgresLister(f.Informer().GetIndexer())
}
