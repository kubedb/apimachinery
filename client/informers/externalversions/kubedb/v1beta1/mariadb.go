	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().MariaDBs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().MariaDBs(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.MariaDB{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mariaDBInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.MariaDB{}, f.defaultInformer)
}

func (f *mariaDBInformer) Lister() v1beta1.MariaDBLister {
	return v1beta1.NewMariaDBLister(f.Informer().GetIndexer())
}
