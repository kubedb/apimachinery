	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().ProxySQLs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().ProxySQLs(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.ProxySQL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *proxySQLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.ProxySQL{}, f.defaultInformer)
}

func (f *proxySQLInformer) Lister() v1beta1.ProxySQLLister {
	return v1beta1.NewProxySQLLister(f.Informer().GetIndexer())
}
