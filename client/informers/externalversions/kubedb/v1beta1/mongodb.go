	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().MongoDBs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().MongoDBs(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.MongoDB{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mongoDBInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.MongoDB{}, f.defaultInformer)
}

func (f *mongoDBInformer) Lister() v1beta1.MongoDBLister {
	return v1beta1.NewMongoDBLister(f.Informer().GetIndexer())
}
