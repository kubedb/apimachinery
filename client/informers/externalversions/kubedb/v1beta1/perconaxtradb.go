...
type PerconaXtraDBInformer interface {
	...
	Lister() v1beta1.PerconaXtraDBLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().PerconaXtraDBs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().PerconaXtraDBs(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.PerconaXtraDB{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *perconaXtraDBInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.PerconaXtraDB{}, f.defaultInformer)
}

func (f *perconaXtraDBInformer) Lister() v1beta1.PerconaXtraDBLister {
	return v1beta1.NewPerconaXtraDBLister(f.Informer().GetIndexer())
}
