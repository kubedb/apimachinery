...
type MemcachedInformer interface {
	...
	Lister() v1beta1.MemcachedLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().Memcacheds(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().Memcacheds(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.Memcached{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *memcachedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.Memcached{}, f.defaultInformer)
}

func (f *memcachedInformer) Lister() v1beta1.MemcachedLister {
	return v1beta1.NewMemcachedLister(f.Informer().GetIndexer())
}
