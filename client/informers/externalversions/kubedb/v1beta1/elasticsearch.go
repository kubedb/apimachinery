...
import (
	...
	kubedbv1beta1 "kubedb.dev/apimachinery/apis/kubedb/v1beta1"
	versioned "kubedb.dev/apimachinery/client/clientset/versioned"
	internalinterfaces "kubedb.dev/apimachinery/client/informers/externalversions/internalinterfaces"
	v1beta1 "kubedb.dev/apimachinery/client/listers/kubedb/v1beta1"
...
type ElasticsearchInformer interface {
	...
	Lister() v1beta1.ElasticsearchLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().Elasticsearches(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().Elasticsearches(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.Elasticsearch{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *elasticsearchInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.Elasticsearch{}, f.defaultInformer)
}

func (f *elasticsearchInformer) Lister() v1beta1.ElasticsearchLister {
	return v1beta1.NewElasticsearchLister(f.Informer().GetIndexer())
}
