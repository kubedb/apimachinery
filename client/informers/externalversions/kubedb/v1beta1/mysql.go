	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1beta1().MySQLs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1beta1().MySQLs(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1beta1.MySQL{},
		resyncPeriod,
...
func (f *mySQLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1beta1.MySQL{}, f.defaultInformer)
}

func (f *mySQLInformer) Lister() v1beta1.MySQLLister {
	return v1beta1.NewMySQLLister(f.Informer().GetIndexer())
}
