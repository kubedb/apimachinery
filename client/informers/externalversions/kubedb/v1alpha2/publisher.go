...
type PublisherInformer interface {
	...
	Lister() v1alpha2.PublisherLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Publishers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Publishers(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1alpha2.Publisher{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *publisherInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1alpha2.Publisher{}, f.defaultInformer)
}

func (f *publisherInformer) Lister() v1alpha2.PublisherLister {
	return v1alpha2.NewPublisherLister(f.Informer().GetIndexer())
}
