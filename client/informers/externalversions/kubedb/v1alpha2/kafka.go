	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Kafkas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Kafkas(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1alpha2.Kafka{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kafkaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1alpha2.Kafka{}, f.defaultInformer)
}

func (f *kafkaInformer) Lister() v1alpha2.KafkaLister {
	return v1alpha2.NewKafkaLister(f.Informer().GetIndexer())
}
