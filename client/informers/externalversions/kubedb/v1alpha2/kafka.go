...
type KafkaInformer interface {
	...
	Lister() kubedbv1alpha2.KafkaLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Kafkas(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Kafkas(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Kafkas(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Kafkas(namespace).Watch(ctx, options)
			},
		},
		&apiskubedbv1alpha2.Kafka{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kafkaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubedbv1alpha2.Kafka{}, f.defaultInformer)
}

func (f *kafkaInformer) Lister() kubedbv1alpha2.KafkaLister {
	return kubedbv1alpha2.NewKafkaLister(f.Informer().GetIndexer())
}
