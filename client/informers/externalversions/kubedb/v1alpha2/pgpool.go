...
type PgpoolInformer interface {
	...
	Lister() kubedbv1alpha2.PgpoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Pgpools(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Pgpools(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Pgpools(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Pgpools(namespace).Watch(ctx, options)
			},
		},
		&apiskubedbv1alpha2.Pgpool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pgpoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubedbv1alpha2.Pgpool{}, f.defaultInformer)
}

func (f *pgpoolInformer) Lister() kubedbv1alpha2.PgpoolLister {
	return kubedbv1alpha2.NewPgpoolLister(f.Informer().GetIndexer())
}
