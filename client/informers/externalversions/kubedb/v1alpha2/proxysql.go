...
type ProxySQLInformer interface {
	...
	Lister() v1alpha2.ProxySQLLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().ProxySQLs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().ProxySQLs(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1alpha2.ProxySQL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *proxySQLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1alpha2.ProxySQL{}, f.defaultInformer)
}

func (f *proxySQLInformer) Lister() v1alpha2.ProxySQLLister {
	return v1alpha2.NewProxySQLLister(f.Informer().GetIndexer())
}
