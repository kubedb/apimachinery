...
type ProxySQLInformer interface {
	...
	Lister() kubedbv1alpha2.ProxySQLLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().ProxySQLs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().ProxySQLs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().ProxySQLs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().ProxySQLs(namespace).Watch(ctx, options)
			},
		},
		&apiskubedbv1alpha2.ProxySQL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *proxySQLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubedbv1alpha2.ProxySQL{}, f.defaultInformer)
}

func (f *proxySQLInformer) Lister() kubedbv1alpha2.ProxySQLLister {
	return kubedbv1alpha2.NewProxySQLLister(f.Informer().GetIndexer())
}
