...
type PostgresInformer interface {
	...
	Lister() kubedbv1alpha2.PostgresLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Postgreses(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Postgreses(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Postgreses(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Postgreses(namespace).Watch(ctx, options)
			},
		},
		&apiskubedbv1alpha2.Postgres{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *postgresInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubedbv1alpha2.Postgres{}, f.defaultInformer)
}

func (f *postgresInformer) Lister() kubedbv1alpha2.PostgresLister {
	return kubedbv1alpha2.NewPostgresLister(f.Informer().GetIndexer())
}
