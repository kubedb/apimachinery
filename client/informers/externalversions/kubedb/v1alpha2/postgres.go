...
type PostgresInformer interface {
	...
	Lister() v1alpha2.PostgresLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Postgreses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Postgreses(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1alpha2.Postgres{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *postgresInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1alpha2.Postgres{}, f.defaultInformer)
}

func (f *postgresInformer) Lister() v1alpha2.PostgresLister {
	return v1alpha2.NewPostgresLister(f.Informer().GetIndexer())
}
