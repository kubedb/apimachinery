...
type MilvusInformer interface {
	...
	Lister() kubedbv1alpha2.MilvusLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Milvuses(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Milvuses(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Milvuses(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Milvuses(namespace).Watch(ctx, options)
			},
		},
		&apiskubedbv1alpha2.Milvus{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *milvusInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubedbv1alpha2.Milvus{}, f.defaultInformer)
}

func (f *milvusInformer) Lister() kubedbv1alpha2.MilvusLister {
	return kubedbv1alpha2.NewMilvusLister(f.Informer().GetIndexer())
}
