	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Milvuses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Milvuses(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1alpha2.Milvus{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *milvusInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1alpha2.Milvus{}, f.defaultInformer)
}

func (f *milvusInformer) Lister() v1alpha2.MilvusLister {
	return v1alpha2.NewMilvusLister(f.Informer().GetIndexer())
}
