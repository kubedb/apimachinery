...
type RedisSentinelInformer interface {
	...
	Lister() kubedbv1alpha2.RedisSentinelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().RedisSentinels(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().RedisSentinels(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().RedisSentinels(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().RedisSentinels(namespace).Watch(ctx, options)
			},
		},
		&apiskubedbv1alpha2.RedisSentinel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisSentinelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubedbv1alpha2.RedisSentinel{}, f.defaultInformer)
}

func (f *redisSentinelInformer) Lister() kubedbv1alpha2.RedisSentinelLister {
	return kubedbv1alpha2.NewRedisSentinelLister(f.Informer().GetIndexer())
}
