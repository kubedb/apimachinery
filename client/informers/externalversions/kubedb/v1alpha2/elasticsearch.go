...
type ElasticsearchInformer interface {
	...
	Lister() v1alpha2.ElasticsearchLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Elasticsearches(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Elasticsearches(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1alpha2.Elasticsearch{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *elasticsearchInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1alpha2.Elasticsearch{}, f.defaultInformer)
}

func (f *elasticsearchInformer) Lister() v1alpha2.ElasticsearchLister {
	return v1alpha2.NewElasticsearchLister(f.Informer().GetIndexer())
}
