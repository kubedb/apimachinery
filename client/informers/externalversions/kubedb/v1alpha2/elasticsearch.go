...
type ElasticsearchInformer interface {
	...
	Lister() kubedbv1alpha2.ElasticsearchLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Elasticsearches(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Elasticsearches(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Elasticsearches(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Elasticsearches(namespace).Watch(ctx, options)
			},
		},
		&apiskubedbv1alpha2.Elasticsearch{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *elasticsearchInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubedbv1alpha2.Elasticsearch{}, f.defaultInformer)
}

func (f *elasticsearchInformer) Lister() kubedbv1alpha2.ElasticsearchLister {
	return kubedbv1alpha2.NewElasticsearchLister(f.Informer().GetIndexer())
}
