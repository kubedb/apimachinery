...
type MemcachedInformer interface {
	...
	Lister() v1alpha2.MemcachedLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Memcacheds(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Memcacheds(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1alpha2.Memcached{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *memcachedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1alpha2.Memcached{}, f.defaultInformer)
}

func (f *memcachedInformer) Lister() v1alpha2.MemcachedLister {
	return v1alpha2.NewMemcachedLister(f.Informer().GetIndexer())
}
