	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1alpha2().Redises(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1alpha2().Redises(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1alpha2.Redis{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1alpha2.Redis{}, f.defaultInformer)
}

func (f *redisInformer) Lister() v1alpha2.RedisLister {
	return v1alpha2.NewRedisLister(f.Informer().GetIndexer())
}
