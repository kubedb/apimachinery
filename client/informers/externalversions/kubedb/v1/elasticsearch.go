	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1().Elasticsearches(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1().Elasticsearches(namespace).Watch(context.TODO(), options)
			},
		},
		&kubedbv1.Elasticsearch{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *elasticsearchInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubedbv1.Elasticsearch{}, f.defaultInformer)
}

func (f *elasticsearchInformer) Lister() v1.ElasticsearchLister {
	return v1.NewElasticsearchLister(f.Informer().GetIndexer())
}
