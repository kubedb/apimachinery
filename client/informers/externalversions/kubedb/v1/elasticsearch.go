...
type ElasticsearchInformer interface {
	...
	Lister() kubedbv1.ElasticsearchLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubedbV1().Elasticsearches(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1().Elasticsearches(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1().Elasticsearches(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubedbV1().Elasticsearches(namespace).Watch(ctx, options)
			},
		},
		&apiskubedbv1.Elasticsearch{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *elasticsearchInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubedbv1.Elasticsearch{}, f.defaultInformer)
}

func (f *elasticsearchInformer) Lister() kubedbv1.ElasticsearchLister {
	return kubedbv1.NewElasticsearchLister(f.Informer().GetIndexer())
}
