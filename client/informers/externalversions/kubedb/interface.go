...
import (
	...
	v1alpha2 "kubedb.dev/apimachinery/client/informers/externalversions/kubedb/v1alpha2"
	v1alpha3 "kubedb.dev/apimachinery/client/informers/externalversions/kubedb/v1alpha3"
)
