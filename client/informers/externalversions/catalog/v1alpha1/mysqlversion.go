...
type MySQLVersionInformer interface {
	...
	Lister() catalogv1alpha1.MySQLVersionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CatalogV1alpha1().MySQLVersions().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CatalogV1alpha1().MySQLVersions().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CatalogV1alpha1().MySQLVersions().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CatalogV1alpha1().MySQLVersions().Watch(ctx, options)
			},
		},
		&apiscatalogv1alpha1.MySQLVersion{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mySQLVersionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscatalogv1alpha1.MySQLVersion{}, f.defaultInformer)
}

func (f *mySQLVersionInformer) Lister() catalogv1alpha1.MySQLVersionLister {
	return catalogv1alpha1.NewMySQLVersionLister(f.Informer().GetIndexer())
}
