...
// KafkaConnectorVersionInformer provides access to a shared informer and lister for
...
// NewKafkaConnectorVersionInformer constructs a new informer for KafkaConnectorVersion type.
...
func NewKafkaConnectorVersionInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredKafkaConnectorVersionInformer(client, resyncPeriod, indexers, nil)
}

// NewFilteredKafkaConnectorVersionInformer constructs a new informer for KafkaConnectorVersion type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *kafkaConnectorVersionInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredKafkaConnectorVersionInformer(client, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
