...
type MariaDBVersionInformer interface {
	...
	Lister() catalogv1alpha1.MariaDBVersionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CatalogV1alpha1().MariaDBVersions().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CatalogV1alpha1().MariaDBVersions().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CatalogV1alpha1().MariaDBVersions().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CatalogV1alpha1().MariaDBVersions().Watch(ctx, options)
			},
		},
		&apiscatalogv1alpha1.MariaDBVersion{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mariaDBVersionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscatalogv1alpha1.MariaDBVersion{}, f.defaultInformer)
}

func (f *mariaDBVersionInformer) Lister() catalogv1alpha1.MariaDBVersionLister {
	return catalogv1alpha1.NewMariaDBVersionLister(f.Informer().GetIndexer())
}
