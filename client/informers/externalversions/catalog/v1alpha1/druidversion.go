...
// DruidVersionInformer provides access to a shared informer and lister for
// DruidVersions.
...
// NewDruidVersionInformer constructs a new informer for DruidVersion type.
...
func NewDruidVersionInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredDruidVersionInformer(client, resyncPeriod, indexers, nil)
}

// NewFilteredDruidVersionInformer constructs a new informer for DruidVersion type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *druidVersionInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredDruidVersionInformer(client, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
