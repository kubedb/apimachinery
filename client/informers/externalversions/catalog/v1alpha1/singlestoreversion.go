...
// SinglestoreVersionInformer provides access to a shared informer and lister for
// SinglestoreVersions.
...
// NewSinglestoreVersionInformer constructs a new informer for SinglestoreVersion type.
...
func NewSinglestoreVersionInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredSinglestoreVersionInformer(client, resyncPeriod, indexers, nil)
}

// NewFilteredSinglestoreVersionInformer constructs a new informer for SinglestoreVersion type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *singlestoreVersionInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredSinglestoreVersionInformer(client, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
