...
type CassandraAutoscalerInformer interface {
	...
	Lister() autoscalingv1alpha1.CassandraAutoscalerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutoscalingV1alpha1().CassandraAutoscalers(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().CassandraAutoscalers(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().CassandraAutoscalers(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().CassandraAutoscalers(namespace).Watch(ctx, options)
			},
		},
		&apisautoscalingv1alpha1.CassandraAutoscaler{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cassandraAutoscalerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisautoscalingv1alpha1.CassandraAutoscaler{}, f.defaultInformer)
}

func (f *cassandraAutoscalerInformer) Lister() autoscalingv1alpha1.CassandraAutoscalerLister {
	return autoscalingv1alpha1.NewCassandraAutoscalerLister(f.Informer().GetIndexer())
}
