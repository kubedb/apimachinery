...
type MariaDBAutoscalerInformer interface {
	...
	Lister() autoscalingv1alpha1.MariaDBAutoscalerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutoscalingV1alpha1().MariaDBAutoscalers(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().MariaDBAutoscalers(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().MariaDBAutoscalers(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().MariaDBAutoscalers(namespace).Watch(ctx, options)
			},
		},
		&apisautoscalingv1alpha1.MariaDBAutoscaler{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mariaDBAutoscalerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisautoscalingv1alpha1.MariaDBAutoscaler{}, f.defaultInformer)
}

func (f *mariaDBAutoscalerInformer) Lister() autoscalingv1alpha1.MariaDBAutoscalerLister {
	return autoscalingv1alpha1.NewMariaDBAutoscalerLister(f.Informer().GetIndexer())
}
