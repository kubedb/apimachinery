...
// ZooKeeperAutoscalerInformer provides access to a shared informer and lister for
...
// NewZooKeeperAutoscalerInformer constructs a new informer for ZooKeeperAutoscaler type.
...
func NewZooKeeperAutoscalerInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredZooKeeperAutoscalerInformer(client, namespace, resyncPeriod, indexers, nil)
}

// NewFilteredZooKeeperAutoscalerInformer constructs a new informer for ZooKeeperAutoscaler type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *zooKeeperAutoscalerInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredZooKeeperAutoscalerInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
