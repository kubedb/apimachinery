...
// DruidAutoscalerInformer provides access to a shared informer and lister for
// DruidAutoscalers.
...
// NewDruidAutoscalerInformer constructs a new informer for DruidAutoscaler type.
...
func NewDruidAutoscalerInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredDruidAutoscalerInformer(client, namespace, resyncPeriod, indexers, nil)
}

// NewFilteredDruidAutoscalerInformer constructs a new informer for DruidAutoscaler type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *druidAutoscalerInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredDruidAutoscalerInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
