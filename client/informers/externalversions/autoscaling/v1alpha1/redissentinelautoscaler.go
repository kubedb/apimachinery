...
type RedisSentinelAutoscalerInformer interface {
	...
	Lister() autoscalingv1alpha1.RedisSentinelAutoscalerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutoscalingV1alpha1().RedisSentinelAutoscalers(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().RedisSentinelAutoscalers(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().RedisSentinelAutoscalers(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().RedisSentinelAutoscalers(namespace).Watch(ctx, options)
			},
		},
		&apisautoscalingv1alpha1.RedisSentinelAutoscaler{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisSentinelAutoscalerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisautoscalingv1alpha1.RedisSentinelAutoscaler{}, f.defaultInformer)
}

func (f *redisSentinelAutoscalerInformer) Lister() autoscalingv1alpha1.RedisSentinelAutoscalerLister {
	return autoscalingv1alpha1.NewRedisSentinelAutoscalerLister(f.Informer().GetIndexer())
}
