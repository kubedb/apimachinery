...
// MemcachedAutoscalerInformer provides access to a shared informer and lister for
...
// NewMemcachedAutoscalerInformer constructs a new informer for MemcachedAutoscaler type.
...
func NewMemcachedAutoscalerInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredMemcachedAutoscalerInformer(client, namespace, resyncPeriod, indexers, nil)
}

// NewFilteredMemcachedAutoscalerInformer constructs a new informer for MemcachedAutoscaler type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *memcachedAutoscalerInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredMemcachedAutoscalerInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
