	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutoscalingV1alpha1().VerticalPodAutoscalerCheckpoints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().VerticalPodAutoscalerCheckpoints(namespace).Watch(context.TODO(), options)
			},
		},
		&autoscalingv1alpha1.VerticalPodAutoscalerCheckpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *verticalPodAutoscalerCheckpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&autoscalingv1alpha1.VerticalPodAutoscalerCheckpoint{}, f.defaultInformer)
}
