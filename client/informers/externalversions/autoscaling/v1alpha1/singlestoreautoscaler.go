...
// SinglestoreAutoscalerInformer provides access to a shared informer and lister for
...
// NewSinglestoreAutoscalerInformer constructs a new informer for SinglestoreAutoscaler type.
...
func NewSinglestoreAutoscalerInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredSinglestoreAutoscalerInformer(client, namespace, resyncPeriod, indexers, nil)
}

// NewFilteredSinglestoreAutoscalerInformer constructs a new informer for SinglestoreAutoscaler type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *singlestoreAutoscalerInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredSinglestoreAutoscalerInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
