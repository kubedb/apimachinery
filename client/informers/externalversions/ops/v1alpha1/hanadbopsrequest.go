...
type HanaDBOpsRequestInformer interface {
	...
	Lister() opsv1alpha1.HanaDBOpsRequestLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpsV1alpha1().HanaDBOpsRequests(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpsV1alpha1().HanaDBOpsRequests(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpsV1alpha1().HanaDBOpsRequests(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpsV1alpha1().HanaDBOpsRequests(namespace).Watch(ctx, options)
			},
		},
		&apisopsv1alpha1.HanaDBOpsRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *hanaDBOpsRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisopsv1alpha1.HanaDBOpsRequest{}, f.defaultInformer)
}

func (f *hanaDBOpsRequestInformer) Lister() opsv1alpha1.HanaDBOpsRequestLister {
	return opsv1alpha1.NewHanaDBOpsRequestLister(f.Informer().GetIndexer())
}
