...
type RedisSentinelOpsRequestInformer interface {
	...
	Lister() opsv1alpha1.RedisSentinelOpsRequestLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpsV1alpha1().RedisSentinelOpsRequests(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpsV1alpha1().RedisSentinelOpsRequests(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpsV1alpha1().RedisSentinelOpsRequests(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpsV1alpha1().RedisSentinelOpsRequests(namespace).Watch(ctx, options)
			},
		},
		&apisopsv1alpha1.RedisSentinelOpsRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisSentinelOpsRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisopsv1alpha1.RedisSentinelOpsRequest{}, f.defaultInformer)
}

func (f *redisSentinelOpsRequestInformer) Lister() opsv1alpha1.RedisSentinelOpsRequestLister {
	return opsv1alpha1.NewRedisSentinelOpsRequestLister(f.Informer().GetIndexer())
}
