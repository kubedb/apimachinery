...
// PgBouncerModificationRequestInformer provides access to a shared informer and lister for
// PgBouncerModificationRequests.
type PgBouncerModificationRequestInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.PgBouncerModificationRequestLister
}
...
func (f *pgBouncerModificationRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dbav1alpha1.PgBouncerModificationRequest{}, f.defaultInformer)
}

func (f *pgBouncerModificationRequestInformer) Lister() v1alpha1.PgBouncerModificationRequestLister {
	return v1alpha1.NewPgBouncerModificationRequestLister(f.Informer().GetIndexer())
}
