...
// MemcachedModificationRequestInformer provides access to a shared informer and lister for
// MemcachedModificationRequests.
type MemcachedModificationRequestInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.MemcachedModificationRequestLister
}
...
func (f *memcachedModificationRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dbav1alpha1.MemcachedModificationRequest{}, f.defaultInformer)
}

func (f *memcachedModificationRequestInformer) Lister() v1alpha1.MemcachedModificationRequestLister {
	return v1alpha1.NewMemcachedModificationRequestLister(f.Informer().GetIndexer())
}
