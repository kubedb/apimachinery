...
func (w *Controller) EnsureDatabaseSnapshot() {
	resourceName := tapi.ResourcePrefixDatabaseSnapshot + "." + tapi.V1beta1SchemeGroupVersion.Group
...
func (w *Controller) EnsureDeletedDatabase() {
	resourceName := tapi.ResourcePrefixDeletedDatabase + "." + tapi.V1beta1SchemeGroupVersion.Group
