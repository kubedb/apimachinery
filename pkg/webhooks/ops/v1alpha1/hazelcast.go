...
func (w *HazelcastOpsRequestCustomWebhook) validateCreateOrUpdate(req *opsapi.HazelcastOpsRequest) error {
	...
	case opsapi.HazelcastOpsRequestTypeStorageMigration:
		if err := w.validateHazelcastStorageMigrationOpsRequest(req, db); err != nil {
...
func (w *HazelcastOpsRequestCustomWebhook) validateHazelcastStorageMigrationOpsRequest(req *opsapi.HazelcastOpsRequest, db *olddbapi.Hazelcast) error {
