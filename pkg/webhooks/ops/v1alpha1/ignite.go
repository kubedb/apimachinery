...
func (rv *IgniteOpsRequestCustomWebhook) validateCreateOrUpdate(req *opsapi.IgniteOpsRequest) error {
	...
	case opsapi.IgniteOpsRequestTypeStorageMigration:
		if err := rv.validateIgniteStorageMigrationOpsRequest(req, db); err != nil {
...
func (rv *IgniteOpsRequestCustomWebhook) validateIgniteStorageMigrationOpsRequest(req *opsapi.IgniteOpsRequest, db *olddbapi.Ignite) error {
