...
const (
	...
	EventReasonFailedToAddMonitor      string = "MonitorAddFailed"
	EventReasonFailedToDeleteMonitor   string = "MonitorDeleteFailed"
	EventReasonFailedToUpdateMonitor   string = "MonitorUpdateFailed"
